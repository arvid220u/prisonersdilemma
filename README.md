...
12. [LEARNING TO COOPERATE WITH PAVLOV AN ADAPTIVE STRATEGY FOR THE ITERATED PRISONER'S DILEMMA WITH NOISE](https://link.springer.com/content/pdf/10.1007/BF01074955.pdf). Simulations, but: introduces a formal notion of "clans" of strategies that are all nice to each other, which I think could be an interesting next step to look at.
13. [The Continuous Prisoner:s Dilemma:II. Linear Reactive Strategies with Noise](https://reader.elsevier.com/reader/sd/pii/S0022519399909979?token=D37DD869C5BC1A32B2B815B449E34B4CA75C76F73C26D6D4BEC64CCBAF979FFD663BAFF039307D92531D6C58E060347C). Seems interesting. Edit: not continuous in the way I thought, so this is only tangentially related.
