...
We may also make $r(c_1,c_2)$ into a vector, denoted by $r$, and write this as \begin{equation*}
...
With these lemmas, we are now ready to prove our first theorem.
    ...
    \begin{proof}[Proof of \cref{evolutionarystable1}]
      ...
      We will first finish the proof of the theorem assuming this claim, and then prove it.
